...
use Core\Model;
use Database\Migrations\CreateFormPaymentsTable;

class FormPayment extends Model implements Models
{
    public static $entity = "FormaPagamento";
    ...
    {
        $sql = (new CreateFormPaymentsTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreateFormPaymentsTable())->down(self::$entity);
