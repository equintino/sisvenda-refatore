...
use Core\Model;
use Database\Migrations\CreateStocksTable;

class Stock extends Model implements Models
{
    public static $entity = "Estoque";
    ...
    {
        $sql = (new CreateStocksTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreateStocksTable())->down(self::$entity);
