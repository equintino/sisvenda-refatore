<nav id="topHeader" class="navbar navbar-expand-lg navbar-dark" >
    ...
    <div class="collapse navbar-collapse pl-4" id="navbarSupportedContent" style="">
        <ul class="nav navbar-nav mr-auto">
            <li class="active">
                <a id="home" class="nav-link" href="<?= url("home") ?>" >Home<span class="sr-only">(current)</span></a>
                <!-- <a id="home" class="nav-link active" href="<?= url("home") ?>" >Home</a> -->
            </li>
            <li class="dropdown" >
        ...
        <div class="navbar navbar-right config">
            <ul class="nav navbar">
                ...
                <li>
                    ...
                    <a id="sair" class="nav-link icon-exit" href="<?= url("sair") ?>" >
