<nav id="topHeader" class="navbar navbar-expand-lg navbar-dark" >
    <a class="navbar-brand" href="http://www.emqdesenv.cf" target="_blank">
        <span><img src="<?= theme("web/img/logo-menu.png") ?>" alt="logo" height="40" /></span></a>
    ...
    <div class="collapse navbar-collapse pl-4" id="navbarSupportedContent" style="">
        <ul class="nav navbar-nav mr-auto">
            <li>
                <a id="home" class="nav-link" href="<?= url('/') ?>" >Home<span class="sr-only">(current)</span></a>
            </li>
            <li class="dropdown" >
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a href="<?= url("/cadastro") ?>" class="dropdown-item" >Cliente</a>
                </div>
            </li>
            <li class="dropdown" >
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a href="<?= url("/orcamento") ?>" class="dropdown-item" >Orçamento</a>
                    <?php endif ?>
                    <?php if (in_array('venda', $access)): ?>
                    <a href="<?= url("/gerenciamento") ?>" class="dropdown-item" >Venda</a>
                    <?php endif; ?>
                    <?php if (in_array('gerEntrega', $access)): ?>
                    <a href="<?= url("/entrega") ?>" class="dropdown-item" >Entrega de Produtos</a>
                    <?php endif; ?>
                    <?php if (in_array('preco', $access)): ?>
                    <a href="<?= url("/preco") ?>" class="dropdown-item" >Preço</a>
                    <?php endif; ?>
                </div>
            </li>
            <li style="text-align: center">
                <a class="nav-link" href="<?= url("/pedido") ?>" >Pedidos & Orçamentos</a></li>
        </ul>
