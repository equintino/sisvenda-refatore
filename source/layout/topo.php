        ...
        <ul class="nav navbar-nav mr-auto">
            ...
            <li class="dropdown" >
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a href="../web/index.php?pagina=cadastro&act=cad_cliente" class="dropdown-item" >Cliente</a>
                </div>
            </li>
            <li class="dropdown" >
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a href="../web/index.php?pagina=gerenciamento-orcamento" 
                        class="dropdown-item" >
                            Orçamento
                    </a>
                    <?php endif ?>
                    <?php if (in_array('venda', $paginas)): ?>
                    <a href="../web/index.php?pagina=venda" 
                        class="dropdown-item" >
                            Venda
                    </a>
                    <?php endif; ?>
                    <?php if (in_array('gerEntrega', $paginas)): ?>
                    <a href="../web/index.php?pagina=gerEntrega" 
                        class="dropdown-item" >
                            Entrega de Produtos
                    </a>
                    <?php endif; ?>
                    <?php if (in_array('preco', $paginas)): ?>
                    <a href="../web/index.php?pagina=preco" 
                        class="dropdown-item" >
                            Preço
                    </a>
                    <?php endif; ?>
            ...
            <li style="text-align: center">
                <a class="nav-link" href="../web/index.php?pagina=orcamento" >Pedidos & Orçamentos</a>
            </li>
        </ul>
        <div class="navbar navbar-right config">
            <a class="nav-link icon-login" id="login" href="../web/index.php?pagina=cadastro" >
                <i class="fa fa-id-card" title="Cadastro de Login"></i></a>
            <a class="nav-link icon-shield" id="shield" href="../web/index.php?pagina=seguranca" >
                <i class="fa fa-shield" title="Segurança" ></i></a>
            <a class="nav-link icon-config" id="config" href="../web/index.php?pagina=configuracao" >
                <i class="fa fa-cog" title="Configuração" ></i></a>
            <a class="nav-link icon-exit" id="exit" href="../web/sair.php" >
                <i class="fa fa-sign-out" title="Sair" ></i></a>
        </div><!-- navbar rigth-->
    </div><!-- navbar-collapse -->
</nav>
